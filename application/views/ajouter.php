<div class="container_page">
    <div class="container">
        <div class="corps"  id="form_ajoutTrajet">
            <h3>AJOUTER UN TRAJET</h3>
            <hr>
            <form method="POST" action =<?php echo site_url('publier');?>>
                <fieldset>
                ...
                <fieldset>
                    ...
                    <br>
                    <img  src="<?php echo img_url('marker_3.png')?>"> <label>à</label> <b>IUT de Lens</b>
                    <br>
