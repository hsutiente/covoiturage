...
<head>
    ...
    <script type="text/javascript">
        ...
        function create_champ(i) {
            ...
            document.getElementById('par_'+i).innerHTML += (i <= 5) ? '<br /><br /> <span id="par_'+nb+'"><img src="<?php echo img_url('marker_2.png')?>"> <label>Par</label> <a class="btn btn-default" href="javascript:create_champ('+nb+')">Ajouter une étape</a> <span Style="color:Gray;">ASTUCE : ajouter des étapes permet de trouver plus de passagers!</span>  <a rel="tooltip" title="Choisis jusqu\'à 5 lieux / villes le long de ton itinéraire comme étapes – ça en vaut la peine."><img src="<?php echo img_url('icon_tooltip.gif');?>"></a></span>' : '';
